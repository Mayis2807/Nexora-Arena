                ...
                <form action="{{ route('login') }}" method="POST">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="email" name="email" value="{{ old('email') }}"
                            style="width: 100%; background: #0A0A0F; border: 1px solid {{ $errors->has('email') ? '#ff6b6b' : '#ffffff20' }}; 
                            border-radius: 8px; padding: 10px 14px; color: #ffffff; outline: none;"
                    ...
                    <div class="mb-4">
                        ...
                        <input type="password" name="password"
                            style="width: 100%; background: #0A0A0F; border: 1px solid {{ $errors->has('password') ? '#ff6b6b' : '#ffffff20' }}; 
                            border-radius: 8px; padding: 10px 14px; color: #ffffff; outline: none;"
